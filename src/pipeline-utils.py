...
# Example usage:
folders_and_labels = [
    (os.path.join(os.path.dirname(__file__), '..', 'raw_data', 'aclImdb', 'test', 'neg'), 'negative'),
    (os.path.join(os.path.dirname(__file__), '..', 'raw_data', 'aclImdb', 'test', 'pos'), 'positive'),
    (os.path.join(os.path.dirname(__file__), '..', 'raw_data', 'aclImdb', 'train', 'neg'), 'negative'),
    (os.path.join(os.path.dirname(__file__), '..', 'raw_data', 'aclImdb', 'train', 'pos'), 'positive'),
]
